...
export default function IndexPage() {
    ...
    return (
      <>
        ...
        <div>
            <h3 className="font-semibold text-3xl text-center">How Can We Help You?</h3>
            <div className="flex justify-evenly container mx-auto">
              <div className="">
                <img src="img/mobile&web.png" alt="" className="h-28"/>
                <p className="font-semibold text-xl">Mobile & Web</p>
              </div>
              <div className="">
                <img src="img/monitor.svg" alt="" className="h-28"/>
                <p className="font-semibold text-xl">Data Analysis</p>
              </div>
              <div className="">
                <img src="img/automation.svg" alt="" className="h-28"/>
                <p className="font-semibold text-xl">End to End Business Auomation</p>
              </div>
            </div>
        </div>                             
      </>
