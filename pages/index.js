                    ...
                    <div className="container px-6 mx-auto">
                        <div className="flex justify-between items-center h-16">
                            ...
                            <ul className="xl:flex hidden items-center h-full">
                                <li className="cursor-pointer h-full flex items-center text-sm text-indigo-700 tracking-normal">About</li>
                                <li className="cursor-pointer h-full flex items-center text-sm hover:text-indigo-700 text-gry-800 mx-10 tracking-normal relative" onClick={() => setServices(!services)}>
                                    {services && (
                                ...
                                <li className="cursor-pointer h-full flex items-center text-sm hover:text-indigo-700 text-gray-800 tracking-normal relative mr-8" onClick={() => setDigitalMar(!digitalMar)}>
                                  {digitalMar && (
                                      <ul className="bg-white shadow rounded py-1 w-32 left-0 mt-16 -ml-4 absolute  top-0">
                                          <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Landing Pages</li>
                                          <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Templates</li>
                                ...
                                <li className="cursor-pointer h-full flex items-center text-sm hover:text-indigo-700 text-gray-800 tracking-normal relative mr-8" onClick={() => setEcomm(!ecomm)}>
                                  {ecomm && (
                                      <ul className="bg-white shadow rounded py-1 w-32 left-0 mt-16 -ml-4 absolute  top-0">
                                          <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Landing Pages</li>
                                          <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Templates</li>
                                ...
                                <li className="cursor-pointer h-full flex items-center text-sm hover:text-indigo-700 text-gray-800 tracking-normal relative mr-8" onClick={() => setTech(!tech)}>
                                    {tech && (
                                        <ul className="bg-white shadow rounded py-1 w-32 left-0 mt-16 -ml-4 absolute  top-0">
                                            <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Landing Pages</li>
                                            <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-indigo-700 hover:text-white px-3 font-normal">Templates</li>
                                ...
                                <li className="cursor-pointer h-full flex items-center text-sm hover:text-indigo-700 text-gry-800 mr-10 tracking-normal">Careers</li>
                                <li className="cursor-pointer h-full flex items-center text-sm hover:text-indigo-700 text-gry-800 mr-10 tracking-normal">Contact Us</li>
                                <li className="cursor-pointer h-full flex items-center text-sm hover:text-indigo-700 text-gry-800 mr-10 tracking-normal">Products</li>
                            </ul>
                        </div>
                    </div>
                </nav>
                                        ...
                                        <div className="mt-6 flex w-full items-center justify-between">
                                            <div className="flex items-center justify-between w-full">
                                                <div className="flex items-center">
                                                    ...
                                                    <p className="text-base md:text-base text-gray-800 ml-3">The North</p>
                                                </div>
                                            ...
                                            <a className="cursor-pointer">
                                                <li className="text-gray-800 pt-8">
                                                    <div className="flex items-center">
                                                        ...
                                                        <p className="text-gray-800 xl:text-base md:text-2xl text-base ml-3">Dashboard</p>
                                                    </div>
                                                </li>
                                            </a>
                                            <a className="cursor-pointer">
                                                <li className="text-indigo-700 pt-8">
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex items-center">
                                                            ...
                                                            <p className="text-indigo-700 xl:text-base text-base ml-3">Products</p>
                                                        </div>
                                                        {services ? (
                                                    ...
                                                    {services && (
                                                        <div>
                                                            <ul className="my-3">
                                                                <li className="xl:text-base md:text-2xl text-base text-indigo-500 hover:text-white py-2 px-6">Best Sellers</li>
                                                                <li className="text-gray-800 xl:text-base md:text-2xl text-base hover:text-indigo-500 py-2 px-6">Out of Stock</li>
                                                                <li className="text-gray-800 xl:text-base md:text-2xl text-base hover:text-indigo-500 py-2 px-6">New Products</li>
                                                            </ul>
                                                        </div>
                                                    )}
                                                </li>
