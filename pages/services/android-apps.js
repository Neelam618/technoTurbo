        ...
        <div className="container mx-auto">
            ...
            <div className="mx-auto container f-f-p px-4 xl:px-0 py-24">
                ...
                <div className="flex justify-center w-full">
                        <div style={{width: 300}} className="flex flex-col items-center items-end pr-12 border-r-4 border-gray-300 relative">
                            ...
                            <div className="flex mt-12 flex-col items-center items-end">
                                <h1 className="text-2xl tracking-wide font-semibold">Requirement Analysis</h1>
                            </div>

                        </div>
                        <div style={{width: 300}} className="flex flex-col items-center items-start pl-12 border-gray-400 mt-20 mt-0">
                        <svg xmlns="http://www.w3.org/2000/svg" width={48} height={48} viewBox="0 0 48 48" fill="none">
                            ...
                            <div className="flex mt-12 flex-col items-center items-start">
                            ...
                            <svg className="h-12 mt-20" enable-background="new 0 0 286.054 286.054" version="1.1" viewBox="0 0 286.05 286.05" xmlns="http://www.w3.org/2000/svg">
                                <path d="m143.03 0c-78.987 0-143.03 64.04-143.03 143.03 0 78.996 64.04 143.03 143.03 143.03s143.03-64.031 143.03-143.03c0-78.987-64.04-143.03-143.03-143.03zm0 259.24c-64.183 0-116.21-52.026-116.21-116.21s52.026-116.21 116.21-116.21 116.21 52.026 116.21 116.21-52.026 116.21-116.21 116.21zm6.651-138.39c-4.613 0-9.395 0.867-13.811 1.716l2.762-18.325h34.63c3.316 0 12.89-1.037 12.89-12.971 0-6.222-4.979-10.888-13.445-10.888h-44.401c-8.832 0-12.712 2.941-14.365 16.43l-4.604 36.481c-0.188 1.895-0.554 3.629-0.554 5.873 0 2.941 3.683 8.126 10.861 8.126 9.395 0 11.049-5.703 21.74-5.703 11.424 0 17.691 7.08 17.691 17.458 0 10.897-6.633 22.643-19.523 22.643-12.345 0-21.195-11.058-28.561-11.058-6.812 0-12.515 5.364-12.515 11.755 0 15.214 27.443 23.17 40.521 23.17 31.859 0 48.817-19.023 48.817-47.896 1e-3 -20.22-15.839-36.811-38.133-36.811z" fill="#2394BC" />
                            </svg>
                        </div>
                    </div>
{/* 
		...
		c23.152,0,41.084-17.154,41.084-37.527C187.598,154.621,179.445,143.25,167.717,137.637z"/></svg>
                    ...
                    <div className="flex justify-center w-full">
                        <div className="flex flex-col items-center items-end pr-12 border-r-4 border-gray-300 relative">
                            <svg className="bg-green-100 rounded-35 p-5 w-28" enable-background="new 0 0 24 24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m22.25.0H1.75C.785.0.0.785.0 1.75v2.5C0 5.215.785 6 1.75 6h20.5C23.215 6 24 5.215 24 4.25v-2.5C24 .785 23.215.0 22.25.0z" /><path d="m1.75 24h12.5c.965.0 1.75-.785 1.75-1.75V9.75C16 8.785 15.215 8 14.25 8H1.75C.785 8 0 8.785.0 9.75v12.5C0 23.215.785 24 1.75 24z" /><circle cx="21" cy="11" r="3" /><path d="m23.25 19h-4.5c-.414.0-.75.336-.75.75s.336.75.75.75h4.5c.414.0.75-.336.75-.75s-.336-.75-.75-.75z" /><path d="m23.25 22h-4.5c-.414.0-.75.336-.75.75s.336.75.75.75h4.5c.414.0.75-.336.75-.75s-.336-.75-.75-.75z" /><path d="m23.25 16h-4.5c-.414.0-.75.336-.75.75s.336.75.75.75h4.5c.414.0.75-.336.75-.75s-.336-.75-.75-.75z" /></svg>                            <svg className="h-12 mt-20" enable-background="new 0 0 286.054 286.054" version="1.1" viewBox="0 0 286.05 286.05" xmlns="http://www.w3.org/2000/svg">
                                <path d="m143.03 0c-78.987 0-143.03 64.04-143.03 143.03 0 78.996 64.04 143.03 143.03 143.03s143.03-64.031 143.03-143.03c0-78.987-64.04-143.03-143.03-143.03zm0 259.24c-64.183 0-116.21-52.026-116.21-116.21s52.026-116.21 116.21-116.21 116.21 52.026 116.21 116.21-52.026 116.21-116.21 116.21zm32.038-104.11h-5.042v-52.607c0-15.59-8.394-21.937-18.933-21.937-9.449 0-14.535 3.093-18.531 9.94l-40.7 69.565c-1.091 1.707-2.548 3.772-2.548 7.545 0 4.452 3.817 10.11 12.72 10.11h43.793v14.562c0 9.091 1.85 13.364 11.12 13.364s13.078-4.282 13.078-13.364v-14.562h5.042c7.089 0 12.72-4.452 12.72-11.317 1e-3 -6.848-5.63-11.299-12.719-11.299zm-28.686 0h-24.896l24.529-47.816h0.367v47.816z" fill="#2394BC" />
                            </svg>
                            <div className="flex mt-12 flex-col items-center items-end w-8/12">
