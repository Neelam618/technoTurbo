                ...
                <div className="md:mt-24 f-f-p">
                    ...
                    <div className="hidden md:flex justify-center w-full">
                        <div className="flex flex-col items-center md:items-end md:pr-12 md:border-r-4 border-gray-300 relative md:w-1/2">
                            <svg className="mt-10" xmlns="http://www.w3.org/2000/svg" width={127} height={128} viewBox="0 0 127 128" fill="none">
                                <g clipPath="url(#clip0)">
                                    <path d="M64.818 124.636C98.4069 124.636 125.636 97.4069 125.636 63.818C125.636 30.2291 98.4069 3 64.818 3C31.2291 3 4 30.2291 4 63.818C4 97.4069 31.2291 124.636 64.818 124.636Z" fill="#4338ca" fillOpacity="0.25" />
                            ...
                            <svg enable-background="new 0 0 286.054 286.054" version="1.1" viewBox="0 0 286.05 286.05" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="flex flex-col items-center md:items-start md:pl-12 lg:border-gray-400 mt-20 md:mt-0 md:w-1/2">
                            ...
                            <svg className="mt-16" xmlns="http://www.w3.org/2000/svg" width={127} height={129} viewBox="0 0 127 129" fill="none">
                    ...
                    <div className="md:hidden flex flex-col items-center w-full">
                        ...
                        <div className="mt-10">
                            <h1 className="text-2xl text-center tracking-wide font-semibold">Design</h1>
                            <h2 className="text-gray-700 mt-3 text-center text-base leading-6 tracking-wide">Lorem ipsum dolor sit amet, consectetur adipiscing quisque in semper lacinia ante vestibulum nunc. Viverra sem ac, tellus viverra lacinia. Cras lacus.</h2>
                        </div>
                        ...
                        <div className="mt-10">
                            <h1 className="text-2xl tracking-wide text-center font-semibold">Develop</h1>
                            <h2 className="text-gray-700 mt-3 pl-3 text-center text-base leading-6 tracking-wide">Lorem ipsum dolor sit amet, consectetur adipiscing quisque in semper lacinia ante vestibulum nunc. Viverra sem ac, tellus viverra lacinia. Cras lacus.</h2>
                        </div>
                        <svg className="my-10" xmlns="http://www.w3.org/2000/svg" width={127} height={129} viewBox="0 0 127 129" fill="none">
                        ...
                        <div className="flex mt-10 flex-col items-center md:items-start md:w-8/12">
                            <h1 className="text-2xl text-center tracking-wide font-semibold">Test & Integrate</h1>
                            <h2 className="text-gray-700 mt-3 text-center text-base leading-6 tracking-wide">Lorem ipsum dolor sit amet, consectetur adipiscing quisque in semper lacinia ante vestibulum nunc. Viverra sem ac, tellus viverra lacinia. Cras lacus.</h2>
                        </div>
                    </div>
